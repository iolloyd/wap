...
<div id="contenidoLogin"><span style="display:block; margin-bottom:5px; font-size:18px;">Oeps! Ik ben mijn wachtwoord vegeten: </span>
  <table width="100%" border="0" cellspacing="4" cellpadding="0">
    <tr>
    <td width="55%" align="right"><span class="textoNormalBlanco">Vul je GSM nummer in :</span></td>
    <td width="45%" align="right"><label for="telefono"></label>
      <input name="telefono" type="text" id="telefono" value="0650457889" /></td>
  </tr>
</table>


</div>
<div id="btnInicio"><a href="/main/login">Klik hier voor je wachtwoord </a><img src="imagenes/btn.gif" width="43" height="36" /></div>
</form>
<div id="enlacesForm"><a href="/main/olvide_pass">Als je al geregestreert bent , klik dan hier </a></div>
</div>
<div id="textoLegal">
	<p>
