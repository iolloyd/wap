...
<div id="contenedor" style="background-image: url(/imagenes/fondo_login.jpg); background-repeat: no-repeat;">
<div id="contenido">
<form id="f1" name="f1" action="/main/login" method='post'>
<div id="contenidoLogin"><span style="display:block; margin-bottom:5px; font-size:18px;">Vul je gegevens in en start het spel </span>
  <table width="100%" border="0" cellspacing="4" cellpadding="0">
    <tr>
    <td width="55%" align="right"><span class="textoNormalBlanco">GSM-nummer </span></td>
    <td width="45%" align="right"><label for="telefono"></label>
      <input name="telefono" type="text" id="telefono" value="" /></td>
  </tr>
  <tr>
    <td align="right"><span class="textoNormalBlanco">Toegangscode </span></td>
    <td align="right"><label for="codigo"></label>
...
<div id="btnInicio">
	<!--<div id="btnInicio"><a href="/espera">DOE NU MEE</a><a href="juego.htm"></a><img src="/imagenes/btn.gif" width="43" height="36" /></div>-->
	<input type='submit' name='submit' value='submit' style="background: transparent url(/imagenes/button-submit.png) left no-repeat; border:0; width:272px; height:66px; position:absolute; z-index:3; top:-15px; right:-35px; text-indent:-5000em"/>
</div>

</form>
<div id="enlaceUsuariosregistrados"><a href="">Als je al geregestreert bent , klik dan hier </a></div>
</div>
<div id="textoLegal">
...
<ul id="legal_links">
	<li><a href="/main/handys.htm">Geschikte toestellen</a> |</li>
    <li><a href="/main/show_abg.htm">Algemene Voorwaarden</a> |</li>
    <li><a href="/main/privacy.htm">Privacy Statement</a> |</li>
    <li><a href="/main/impressum.htm">Impressum</a> |</li>
    <li><a href="#">FAQs</a> |</li>
