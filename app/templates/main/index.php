	<div id="contenedor" style="background-image: url(/imagenes/fondo_entrada.jpg); background-repeat: no-repeat;">
		<div id="contenido">
			<form id="f1" name="f1" method='POST' action="/main/login">
				<div id="contenidoEntrada">
				<div id="atention"></div>
				  <table width="100%" border="0" cellspacing="4" cellpadding="0">
					<tr>
					  <td width="55%" align="right">
						<span class="textoNormalBlanco">Vul hier je GSM nummer </span>
					  </td>
					  <td width="45%" align="right">
						<label for="telefono"></label>
						<input name="telefono" type="text" id="telefono" maxlength="10" value="06" /></td>
					</tr>
				</table>

				</div>
		
				<a href="#" onclick="javascript:valida(document.f1); return false" id="btn_submit"></a>
			<!--<input type="submit" value="submit" name="submit" id="btn_submit" onclick="javascript:valida(document.f1); return false">-->
		
			</form>
			<div id="enlacesForm">
				<a href="/main/olvide_pass">
					Als je al geregestreert bent , klik dan hier
				</a>
			</div>
		</div>
		<div id="textoLegal">
